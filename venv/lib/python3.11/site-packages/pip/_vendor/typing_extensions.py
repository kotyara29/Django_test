...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        they are also supported in customer-defined Generics at runtime.
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        """Special typing form used to annotate the return type of a customer-defined
        ...
        Sometimes it would be convenient to use a customer-defined boolean function
        ...
        writing type-safe type guards is left to the customer.
...
# 3.7-3.8
    ...
    TypeGuard = _TypeGuardForm(
        'TypeGuard',
        doc="""Special typing form used to annotate the return type of a customer-defined
        type guard function.  ``TypeGuard`` only accepts a single type argument.
        At runtime, functions marked this way should return a boolean.
...
if sys.version_info >= (3, 11):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns):
            ...
            # update from customer namespace without overriding special namedtuple attributes
            for key in ns:
